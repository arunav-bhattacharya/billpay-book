...
*(Shape, simplified.)* Which groups carry dimensions and which are generic, all 22 of them with their transitions and invoking stages, is catalogued in [Design → ActivityGroups & Activities](../../../design/activities.md).
