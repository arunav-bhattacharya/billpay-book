...
- billpay-core is the REST APIs, the [Billpay Router](../design/component-model/routing.md), and the [Worker App](../deployment/deployables/worker-app.md) hosting both Temporal worker pools. An instance runs in each site.
