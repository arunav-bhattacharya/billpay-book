    ...
    layers: [
      ...
      },
      {
        ...
        items: [
          ...
          {label: 'ReadPayments.v1', code: true},
          {label: 'ReadPaymentEventsById.v1', code: true},
          {label: 'CreateCreditBalanceRefund.v1', code: true},
          {label: 'CreateInboundPayment.v1', code: true},
          {label: 'CreatePaymentIntent.v1', code: true},
        ],
      },
    ],
  },
    ...
    layers: [
      {
        ...
        icon: 'router',
        items: ['REST APIs', 'date routing', 'single / multi-instruction', 'dimensions → stages'],
      },
      {
        title: 'Workflows',
