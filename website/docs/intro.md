...
- All diagrams on this site are written in [Mermaid](https://mermaid.js.org/) and render natively, so you can copy one straight into Confluence or another Mermaid host.
